        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 lg:gap-10 mb-40 md:mb-8 lg:mb-4 ">
              ...
              <Card title="Layerify-AI" description="It lets you to remove background image, change background and add text between layers for Free of cost with high quality." github="https://github.com/YogeshSinghChilwal/layerify-ai" liveLink="https://layerify-ai.vercel.app/" image="/projectsPic/layerifyProjectImage.png" date="Fab, 2025" />
